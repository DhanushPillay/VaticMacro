...
def create_features(df):
    ...
    if "DEXINUS" in df.columns and "Average of DCOILBRENTEU" in df.columns:
        ...
        df["brent_vol_12m"] = (
            df["Average of DCOILBRENTEU"].pct_change(1).rolling(12).std() * 100
        )
...
FEATURE_COLUMNS: list[str] = [
    ...
    "WPIATT01INM661N_pct_1m",
    "WPIATT01INM661N_pct_12m",
    "WPIATT01INM661N_rolling_6m",
    "INTDSRINM193N_pct_1m",
    "INTDSRINM193N_pct_12m",
    "INTDSRINM193N_rolling_6m",
    "DEXINUS_pct_1m",
    "DEXINUS_pct_12m",
    "DEXINUS_rolling_6m",
    "Average of DCOILBRENTEU_pct_1m",
    "Average of DCOILBRENTEU_pct_12m",
    "Average of DCOILBRENTEU_rolling_6m",
    "WPI_CPI_ratio",
    "WPI_CPI_pct_1m",
    "oil_inr_ratio",
    "oil_inr_pct_1m",
